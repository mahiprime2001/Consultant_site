...
import { Award, Users, Clock, TrendingUp, MapPin, Calendar, Github, Brain } from 'lucide-react';
...
export const About = () => {
  ...
  const milestones = [
    ...
    },
    {
      ...
      description: 'Served 20+ clients in Nellore, launched comprehensive AI and DevOps service platform'
    },
    {
      year: '2025',
      title: 'Growth Target',
      description: 'Targeting ₹75 lakh revenue with 15 business clients, 50 individual clients, and blog launch'
    },
    {
      year: '2026',
      title: 'Expansion Phase',
      description: 'Expanding to Hyderabad, partnering with AWS/Azure, targeting ₹1.2 crore'
    },
    {
      year: '2027',
      title: 'National Presence',
      description: 'Pan-India operations with ₹2 crore revenue target'
    }
  ];
