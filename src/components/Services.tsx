...
import { Brain, Cog as Cogs, Cloud, Shield, Database, Monitor, Users, Smartphone, Home, GraduationCap, GitBranch, Bot } from 'lucide-react';
        ...
        <div className="text-center mb-16">
          ...
          <div className="bg-blue-100 rounded-lg p-4 inline-block">
            <p className="text-blue-800 font-medium">
              For detailed pricing and service information, visit{' '}
              <a href="https://ifleon.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-900">
                ifleon.com
              </a>{' '}
              or contact{' '}
